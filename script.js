...
function activateGroup(project) {
  ...
  setTimeout(() => {
    ...
    // Keep the group positioned at the left-center of the screen
    ...
    // Set the camera target to the world coordinates of the group, so it focuses on the left-center
