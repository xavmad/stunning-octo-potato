...
function activateGroup(project) {
  ...
  setTimeout(() => {
    ...
    // FIXED position: Set the group to be at the exact left-center of the screen
    ...
    // Place images starting at the fixed left-center (10% from left and vertically centered)
