...
images.forEach(img => {
  // Randomize the initial position of each image
  ...
  // Assign random velocities for floating
...
floatImages(); // Trigger the floating motion immediately after load
...
function activateGroup(project) {
  ...
  setTimeout(() => {
    ...
    // Smooth transition to focus on the group
