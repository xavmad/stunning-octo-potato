...
function activateGroup(project) {
  ...
  setTimeout(() => {
    ...
    /* ==========================================
       CANVAS COORDINATES (0 → width/height)
    ========================================== */

    const LEFT   = HALF;
    const RIGHT  = window.innerWidth  - HALF;
    const TOP    = HALF;
    const BOTTOM = window.innerHeight - HALF;

    /* anchor = center of left half */
    const ANCHOR_X = window.innerWidth * 0.25;
    const ANCHOR_Y = window.innerHeight * 0.5;
