...
function activateGroup(project) {
  ...
  setTimeout(() => {
    ...
    /* ==========================================
       WORLD-SPACE SAFE BOUNDS
    ========================================== */

    const SAFE_LEFT   = -window.innerWidth * 0.15;
    const SAFE_RIGHT  =  window.innerWidth * 0.45;
    const SAFE_TOP    = -window.innerHeight * 0.45;
    const SAFE_BOTTOM =  window.innerHeight * 0.45;

    /* center spiral inside bounds */
    ...
    /* ==========================================
       ...
       camera must look at group center
    ========================================== */
