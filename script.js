...
function activateGroup(project) {
  ...
  setTimeout(() => {
    ...
    /* ==========================================
       WORLD SPACE — CORRECT & ZOOM-SAFE
    ========================================== */

    // screen center in WORLD space
    const worldCenterX =
      (CAMERA_CENTER_X - originX) / scale;
    const worldCenterY =
      (CAMERA_CENTER_Y - originY) / scale;

    // exact center-left of screen (25% from left)
    const CENTER_X =
