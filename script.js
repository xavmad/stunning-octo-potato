...
function activateGroup(project) {
  ...
  setTimeout(() => {
    ...
    // left-center of screen in world coords (only adjust the center point)
    const LEFT_CENTER_X = -window.innerWidth * 0.4;  // Fixed 40% from the left
    const CENTER_Y = 0;
    ...
    groupImages.forEach((img, i) => {
      ...
      const x = LEFT_CENTER_X + Math.cos(angle) * radius;
