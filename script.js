...
function zoomAt(screenX, screenY, newScale) {
  // Calculate the current position of the mouse/finger in world space
  ...
  // Update the target origin to keep the zoom focused on the cursor
...
viewport.addEventListener("wheel", e => {
  ...
  // Use zoomAt to ensure zooming is anchored to the cursor position
...
viewport.addEventListener("touchmove", e => {
  ...
  if (e.touches.length === 2) {
    ...
    // Use zoomAt to ensure zooming is anchored to the touch point
