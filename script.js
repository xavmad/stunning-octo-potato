...
function activateGroup(project) {
  ...
  setTimeout(() => {
    ...
    // Fixed positioning: place group at center-left of the screen
    const CENTER_X = window.innerWidth * 0.1;  // 10% from the left of the screen
    const CENTER_Y = window.innerHeight * 0.5; // Centered vertically
