...
function activateGroup(project) {
  ...
  setTimeout(() => {
    ...
    // Fixed position: ensure group is centered to the left
    const CENTER_X = window.innerWidth * 0.1; // Fixed X for left-center
    ...
    groupImages.forEach((img, i) => {
      ...
      const angle = i * Math.PI * (3 - Math.sqrt(5)); // Golden angle for spiral
