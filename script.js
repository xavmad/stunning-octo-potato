...
function activateGroup(project) {
  ...
  setTimeout(() => {
    ...
    // left-center of screen in world coords (we only change the starting position)
    ...
    groupImages.forEach((img, i) => {
      ...
      // **Key Fix:** Keep the spiral logic the same, but shift the entire group to left-center
